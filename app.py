...
if modulo == "Home":
    ...
    <div style="display:flex; gap:8px; flex-wrap:wrap;">
      ...
      <span style="background:#f3f4f6; border:1px solid #e5e7eb; padding:6px 10px; border-radius:999px;">io</span>
      <span style="background:#f3f4f6; border:1px solid #e5e7eb; padding:6px 10px; border-radius:999px;">matplotlib.pyplot</span>
      <span style="background:#f3f4f6; border:1px solid #e5e7eb; padding:6px 10px; border-radius:999px;">seaborn</span>
      <span style="background:#f3f4f6; border:1px solid #e5e7eb; padding:6px 10px; border-radius:999px;">textwrap</span>
    </div>
    </section>
    </div>
    """)
        ...
        with tabs[8]:
            ...
            if len(numericas_analisis) >= 2:
                ...
                if len(columnas_validas) >= 2:
                    ...
                    fig, ax = plt.subplots(
                        figsize=(
                            max(3, len(columnas_validas)* 0.55),
                            max(2, len(columnas_validas) * 0.40)
                        )
                    )
                    ...
                    ax.set_title("Matriz de correlación", fontsize=5,  pad=6)
